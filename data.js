 ...
 * Atualizado com as datas de modificação das faixas.
 */
...
const PERSONAS_DATA = [
    ...
    },
    {
        ...
        descricao: "Brett é um vocalista country-pop de timbre profundo e macio, que entrega baladas românticas com vibrato leve, dicção clara e uma interpretação calorosa e sincera, combinando a sensibilidade do adult contemporary com a sofisticação acústica e atmosférica do country moderno.",
        ...
        musicas: [
            ...
            { titulo: "🎵 If You Didn’t Feel It (Remastered) ", arquivo: "./assets/musicas/03-bre.mp3", data: "2026-04-10" },
            { titulo: "🎵                ", arquivo: "./assets/musicas/04-bre.mp3", data: "2026-04-05" },
            { titulo: "🎵                ", arquivo: "./assets/musicas/05-bre.mp3", data: "2026-04-05" },
            { titulo: "🎵                ", arquivo: "./assets/musicas/06-bre.mp3", data: "2026-04-05" },
            { titulo: "🎵                ", arquivo: "./assets/musicas/07-bre.mp3", data: "2026-04-05" },
            { titulo: "🎵                ", arquivo: "./assets/musicas/08-bre.mp3", data: "2026-04-05" },
            { titulo: "🎵                ", arquivo: "./assets/musicas/09-bre.mp3", data: "2026-04-05" },
            { titulo: "🎵                ", arquivo: "./assets/musicas/10-bre.mp3", data: "2026-04-05" }
        ]
    },
    {
        id: 7,
        ...
        descricao: "Galileu é um cantor gospel brasileiro de timbre rasgado e potente, com alcance de baritenor e entrega emocional intensa.",
    ...
    },
    {
        ...
        descricao: "Jean e Cloe são a dupla do gospel contemporâneo que une a força rasgada e apaixonada do vocal masculino com a doçura melismática e soul da voz feminina.",
        ...
        musicas: [
            ...
            { titulo: "🎵 Reflexos de Mim (Versão Dueto) ", arquivo: "./assets/musicas/05-jec.mp3", data: "2026-04-10" },
    ...
    },
   {
       id: 10,
        ...
        descricao: "Um artista de identidade própria, com timbre definido e emocional, articulação marcante e controle técnico refinado.",
    ...
    },
    {
        ...
        descricao: "Um cantor de voz masculina profunda e marcante, com interpretação intensa e emocional.",
        ...
        musicas: [            { titulo: "🎵 ", arquivo: "./assets/musicas/01-scot.mp3", data: "2026-04-06" },
            ...
            { titulo: "🎵 A locket in my ches ", arquivo: "./assets/musicas/05-scot.mp3", data: "2026-04-06" },
    ...
    },
    {
        ...
        descricao: "Cantora espanhola de voz feminina suave e profundamente emocional.",
    ...
    },
    {
        ...
        descricao: "Vocalista de voz projetada, crua e intensa.",
